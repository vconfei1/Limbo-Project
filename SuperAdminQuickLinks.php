...
<html>
	...
	<body>
		...
		<h1>Limbo Items</h1>
		<h2> Here is a list of items in our database. To see more information about an item, click it's ID.</h2>
...
#Show the records
show_link_recordsSA($dbc);
show_form_search($dbc, $column, $descr);

function show_form_search($dbc, $column, $descr){
	#echo'<p> Hello';
	echo '<form action ="SuperAdminQuickLinks.php" method="POST" class="centering">';
