...
<html>
	...
	<body>
		...
		<div class = "div3">
			<h5 class="custom"><a href = "http://127.0.0.1:8888/SuperAdminDeleteStuff.php">Delete Stuff</a><h5>
		</div> 
		<br>
		...
		<h4 class="custom">All fields marked with a * are required</h4>
	</body>
</html>
<?php
...
if ($_SERVER['REQUEST_METHOD']=='POST'){
	...
	if (!empty($errors))
	{
		echo '<p style="color:red;"> Error! Please enter: ';
...
show_formSAdminAdd($Icat, $Iname, $descr, $location, $date, $room, $owner, $oPhoneNumber, $oEmail, $finder, $fPhoneNumber, $fEmail);
function show_formSAdminAdd($Icat, $Iname, $descr, $location, $date, $room, $owner, $oPhoneNumber, $oEmail, $finder, $fPhoneNumber, $fEmail){
echo '<form action ="SAdminAddStuff.php" method="POST">';
